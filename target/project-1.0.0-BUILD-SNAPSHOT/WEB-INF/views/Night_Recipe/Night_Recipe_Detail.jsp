...
<input type="hidden" name="u_m_name" value="${Night_Recipe_Mainimage[0].m_name}">
<input type="hidden" name="u_m_img_url" value="${Night_Recipe_Mainimage[0].m_img_url}">
<input type="hidden" name="u_m_view" value="${Night_Recipe_Mainimage[0].m_view}">
<input type="hidden" name="u_m_url" value="${Night_Recipe_Mainimage[0].m_url}">



<div id="Text">
<div class="card mb-3 col col-md-6  border border-5">
  <img src="${Night_Recipe_Mainimage[0].m_img_url}" class="card-img-top" alt="..." style="height:500px">
  <div class="card-body">
    <h5 class="card-title" style="font-size:15pt;">Making delicious Food</h5>
    <p class="card-text" style="font-size:15pt;">${Night_Recipe_Mainimage[0].m_name}</p>
    <p class="card-text"><small class="text-muted" style="font-size:15pt;">조회수 : ${Night_Recipe_Mainimage[0].m_view} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               			<%
				   if (userID != null) {
				%>
...
<div class="card text-bg-primary mb-3"  style="max-width: 30rem; height:30rem"  id="ingredient">
  ...
  <div class="card-body text-secondary">
    ...
    <c:forEach var="i" items="${Night_Recipe_ingredient}">
  ...
  <div class="card-body text-secondary">
    ...
    <div class="card-text"><img src="resources/img/clock.png" style="width:70px;height:70px">&emsp; ${Night_Recipe_introduce[0].i_time}</div><p>
    <div class="card-text"><img src="resources/img/hot-food.png" style="width:70px;height:70px">&emsp;${Night_Recipe_introduce[0].i_servings } </div><p>
    <div class="card-text"><img src="resources/img/level-up.png" style="width:70px;height:70px"> &emsp;${Night_Recipe_introduce[0].i_level } </div>
...
<c:forEach var="s" items="${Night_Recipe_seqence}" varStatus="status">
  <div class="col">
    <div class="card ">
