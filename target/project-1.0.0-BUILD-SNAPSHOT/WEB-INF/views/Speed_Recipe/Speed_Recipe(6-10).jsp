...
<div class="number">
  <ul class="pagination">
    <li class="page-item">
  	<form action="Speed_Recipe6" method="get">
      <a class="page-link" href="getSpeed_Recipe_1Page" aria-label="Previous">
        <span aria-hidden="true bg-secondary">&laquo;</span>
      </a>
    </li>
    <li class="page-item "><input type="submit" name="1" value="6" class="page-link" /></li>
    <li class="page-item "><input type="submit" name="1" value="7" class="page-link" /></li>
    <li class="page-item "><input type="submit" name="1" value="8" class="page-link" /></li>
    <li class="page-item "><input type="submit" name="1" value="9" class="page-link" /></li>
    <li class="page-item "><input type="submit" name="1" value="10" class="page-link" /></li>

    <li class="page-item">
      <a class="page-link" href="getSpeed_Recipe_11Page" aria-label="Next">
