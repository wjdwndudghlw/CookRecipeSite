                  ...
                  <div class="listing-item">
                    ...
                    <div class="right-content align-self-center">
                     ...
                     <form action= "showDetailSeasonRecipe">
                      ...
                      <input type="hidden" name="u_m_name" value="${SeasonRecipe.m_name}">
                      <input type="hidden" name="u_m_img_url" value="${SeasonRecipe.m_img_url}">
                      <input type="hidden" name="u_m_view" value="${SeasonRecipe.m_view}">
                      <input type="hidden" name="u_m_url" value="${SeasonRecipe.m_url}">
