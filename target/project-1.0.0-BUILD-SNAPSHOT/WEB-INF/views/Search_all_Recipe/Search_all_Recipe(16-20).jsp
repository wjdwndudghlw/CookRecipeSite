		...
		<ul class="pagination">
			<li class="page-item">
				<form action="getall_Recipe_Foodall" method="get">
					<a class="page-link" href="getall_Recipe_foodall_11page"
						aria-label="Previous"> <span aria-hidden="true bg-secondary">&laquo;</span>
					</a>
			</li>
			<li class="page-item "><input type="submit" name="pageNO" value="16"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="17"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="18"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="19"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="20"
				class="page-link" /></li>

			<li class="page-item"><a class="page-link"
				href="getall_Recipe_foodall_21page" aria-label="Next"> <span
