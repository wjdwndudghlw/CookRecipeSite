		...
		<ul class="pagination">
			<li class="page-item">
				<form action="getall_Recipe_Foodall" method="get">
					<a class="page-link" href="getall_Recipe_foodall_41page"
						aria-label="Previous"> <span aria-hidden="true bg-secondary">&laquo;</span>
					</a>
			</li>
			<li class="page-item "><input type="submit" name="pageNO" value="46"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="47"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="48"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="49"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="50"
				class="page-link" /></li>

			<li class="page-item"><a class="page-link"
				href="getall_Recipe_foodall_51page" aria-label="Next"> <span
