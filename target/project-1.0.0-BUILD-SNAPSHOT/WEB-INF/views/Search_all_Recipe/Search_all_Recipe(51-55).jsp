		...
		<ul class="pagination">
			<li class="page-item">
				<form action="getall_Recipe_Foodall" method="get">
					<a class="page-link" href="getall_Recipe_foodall_46page"
						aria-label="Previous"> <span aria-hidden="true bg-secondary">&laquo;</span>
					</a>
			</li>
			<li class="page-item "><input type="submit" name="pageNO" value="51"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="52"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="53"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="54"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="55"
				class="page-link" /></li>

			<li class="page-item"><a class="page-link"
				href="getall_Recipe_foodall_56page" aria-label="Next"> <span
