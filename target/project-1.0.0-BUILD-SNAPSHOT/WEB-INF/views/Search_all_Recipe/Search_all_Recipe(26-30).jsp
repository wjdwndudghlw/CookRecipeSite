		...
		<ul class="pagination">
			<li class="page-item">
				<form action="getall_Recipe_Foodall" method="get">
					<a class="page-link" href="getall_Recipe_foodall_21page"
						aria-label="Previous"> <span aria-hidden="true bg-secondary">&laquo;</span>
					</a>
			</li>
			<li class="page-item "><input type="submit" name="pageNO" value="26"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="27"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="28"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="29"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="30"
				class="page-link" /></li>

			<li class="page-item"><a class="page-link"
				href="getall_Recipe_foodall_31page" aria-label="Next"> <span
