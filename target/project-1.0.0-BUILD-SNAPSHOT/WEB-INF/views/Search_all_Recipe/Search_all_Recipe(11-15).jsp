		...
		<ul class="pagination">
			<li class="page-item">
				<form action="getall_Recipe_Foodall" method="get">
					<a class="page-link" href="getall_Recipe_foodall_6page"
						aria-label="Previous"> <span aria-hidden="true bg-secondary">&laquo;</span>
					</a>
			</li>
			<li class="page-item "><input type="submit" name="pageNO" value="11"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="12"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="13"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="14"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="15"
				class="page-link" /></li>

			<li class="page-item"><a class="page-link"
				href="getall_Recipe_foodall_16page" aria-label="Next"> <span
