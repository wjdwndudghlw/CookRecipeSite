...
<body>
	...
	<div class="p-3 mb-2 bg-light text-dark">
		<nav class="Classification" style="-bs-breadcrumb-divider: '&gt;';"
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">Food_level(1)</li>
			</ol>
		</nav>
	...
	<div class="number">
		<ul class="pagination">
			<li class="page-item">
				<form action="getall_Recipe_Foodall_foodlevel1" method="get">
					<a class="page-link" href="getall_Recipe_Foodall_foodlevel1_1page"
						aria-label="Previous"> <span aria-hidden="true bg-secondary">&laquo;</span>
					</a>
			</li>
			<li class="page-item "><input type="submit" name="pageNO" value="6"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="7"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="8"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="9"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="10"
				class="page-link" /></li>

			<li class="page-item"><a class="page-link"
				href="getall_Recipe_Foodall_foodlevel1_11page" aria-label="Next"> <span
