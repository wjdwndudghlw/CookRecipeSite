		...
		<ul class="pagination">
			<li class="page-item">
				<form action="getall_Recipe_Foodall" method="get">
					<a class="page-link" href="getall_Recipe_foodall_51page"
						aria-label="Previous"> <span aria-hidden="true bg-secondary">&laquo;</span>
					</a>
			</li>
			<li class="page-item "><input type="submit" name="pageNO" value="56"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="57"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="58"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="59"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="60"
				class="page-link" /></li>
