...
<nav class="Classification" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Food_level all</li>
    <li class="breadcrumb-item active" aria-current="page">${m_name} 검색 결과 : ${TotalCount }개</li>
...
<div class="number">
  <ul class="pagination">
    <li class="page-item">
  	<form action="getall_Recipe_all_Search_name" method="get">
        <input type="hidden" name="m_name" value="${m_name}">
        
    </li>
   <c:if test="${TotalCount >25 }">
    <li class="page-item "><input type="submit" name="pageNO" value="6" class="page-link" /></li>
  </c:if>
      <c:if test="${TotalCount >25 }">
    <li class="page-item "><input type="submit" name="pageNO" value="7" class="page-link" /></li>
    </c:if>
      <c:if test="${TotalCount >50 }">
    <li class="page-item "><input type="submit" name="pageNO" value="8" class="page-link" /></li>
    </c:if>
      <c:if test="${TotalCount >75 }">
    <li class="page-item "><input type="submit" name="pageNO" value="9" class="page-link" /></li>
      </c:if>
        <c:if test="${TotalCount >100 }">
    <li class="page-item "><input type="submit" name="pageNO" value="10" class="page-link" /></li>
    </c:if>
    <li class="page-item">
         <c:if test="${TotalCount >125}">
      <a class="page-link" href="getall_Recipe_all_Search_name_6page" aria-label="Next">
