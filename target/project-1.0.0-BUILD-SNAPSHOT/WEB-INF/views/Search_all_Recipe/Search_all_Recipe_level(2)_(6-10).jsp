...
<body>
	...
	<div class="p-3 mb-2 bg-light text-dark">
		<nav class="Classification" style="-bs-breadcrumb-divider: '&gt;';"
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">Food_level(2)</li>
			</ol>
		</nav>
	...
	<div class="number">
		<ul class="pagination">
			<li class="page-item">
				<form action="getall_Recipe_Foodall_foodlevel2" method="get">
					<a class="page-link" href="getall_Recipe_Foodall_foodlevel2_1page"
			...
			<li class="page-item"><a class="page-link"
				href="getall_Recipe_Foodall_foodlevel2_11page" aria-label="Next"> <span
