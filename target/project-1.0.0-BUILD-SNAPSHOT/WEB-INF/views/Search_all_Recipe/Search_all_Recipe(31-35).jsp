...
<body>
	...
	<div class="p-3 mb-2 bg-light text-dark">
		<nav class="Classification" style="-bs-breadcrumb-divider: '&gt;';"
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">Food_level(all)</li>
			</ol>
		</nav>
	...
	<div class="number">
		<ul class="pagination">
			<li class="page-item">
				<form action="getall_Recipe_Foodall" method="get">
					<a class="page-link" href="getall_Recipe_foodall_26page"
						aria-label="Previous"> <span aria-hidden="true bg-secondary">&laquo;</span>
					</a>
			</li>
			<li class="page-item "><input type="submit" name="pageNO" value="31"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="32"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="33"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="34"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="35"
				class="page-link" /></li>

			<li class="page-item"><a class="page-link"
				href="getall_Recipe_foodall_36page" aria-label="Next"> <span
