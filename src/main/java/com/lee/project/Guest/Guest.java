...
public class Guest {
	...
	public Guest(String m_name, String m_img_url, int m_view, String m_url,String m_level) {
		super();
		this.m_name = m_name;
	...
	public Guest(String i_url, String i_time, String i_servings, String i_level) {
		super();
		this.i_url = i_url;
		this.i_time = i_time;
	...
	public Guest(String i_url1, String i_ingredient, String i_ingredient_dose) {
		super();
		this.i_url1 = i_url1;
	...
	public Guest(int s_no, String s_url, String s_seq, String s_img) {
		super();
		this.s_no = s_no;
		this.s_url = s_url;
		this.s_seq = s_seq;
