...
<style>
.map_wrap, .map_wrap * {margin:0;padding:0;font-family:'Malgun Gothic',dotum,'돋움',sans-serif;font-size:17px;}
...
<div class="p-5  mb-2 bg-light text-dark">
		...
		<div class="row row-cols-lg-auto g-3 align-items-center"
			...
			<div class="col-12">
				<a href="Search_Place" class="btn btn-secondary"
					>카테고리별 검색하기</a>
			</div>
		</div>
	</div>
			...
			<div class="option">
				<div>
					<form onsubmit="searchPlaces(); return false;">
						키워드 : <input type="text" value="이태원 맛집" id="keyword" size="20">
	...
	<script type="text/javascript"
		src="//dapi.kakao.com/v2/maps/sdk.js?appkey=cfbf58e8b2cfb131a87580a36c553b67&libraries=services,clusterer,drawing"></script>
