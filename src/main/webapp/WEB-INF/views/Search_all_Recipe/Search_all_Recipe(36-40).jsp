		...
		<ul class="pagination">
			<li class="page-item">
				<form action="getall_Recipe_Foodall" method="get">
					<a class="page-link" href="getall_Recipe_foodall_31page"
						aria-label="Previous"> <span aria-hidden="true bg-secondary">&laquo;</span>
					</a>
			</li>
			<li class="page-item "><input type="submit" name="pageNO" value="36"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="37"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="38"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="39"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="40"
				class="page-link" /></li>

			<li class="page-item"><a class="page-link"
				href="getall_Recipe_foodall_41page" aria-label="Next"> <span
