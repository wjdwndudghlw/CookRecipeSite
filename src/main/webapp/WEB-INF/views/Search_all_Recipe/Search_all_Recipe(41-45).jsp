		...
		<ul class="pagination">
			<li class="page-item">
				<form action="getall_Recipe_Foodall" method="get">
					<a class="page-link" href="getall_Recipe_foodall_36page"
						aria-label="Previous"> <span aria-hidden="true bg-secondary">&laquo;</span>
					</a>
			</li>
			<li class="page-item "><input type="submit" name="pageNO" value="41"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="42"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="43"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="44"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="45"
				class="page-link" /></li>

			<li class="page-item"><a class="page-link"
				href="getall_Recipe_foodall_46page" aria-label="Next"> <span
