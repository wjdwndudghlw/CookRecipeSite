		...
		<ul class="pagination">
			<li class="page-item">
				<form action="getall_Recipe_Foodall" method="get">
					<a class="page-link" href="getall_Recipe_foodall_16page"
						aria-label="Previous"> <span aria-hidden="true bg-secondary">&laquo;</span>
					</a>
			</li>
			<li class="page-item "><input type="submit" name="pageNO" value="21"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="22"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="23"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="24"
				class="page-link" /></li>
			<li class="page-item "><input type="submit" name="pageNO" value="25"
				class="page-link" /></li>

			<li class="page-item"><a class="page-link"
				href="getall_Recipe_foodall_26page" aria-label="Next"> <span
