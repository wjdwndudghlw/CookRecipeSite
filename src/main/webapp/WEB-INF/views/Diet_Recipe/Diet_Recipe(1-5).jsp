...
<div class="number">
  <ul class="pagination">
    <li class="page-item">
  	<form action="Diet_Recipe" method="get">
      <a class="page-link" href="getDiet_Recipe_1Page" aria-label="Previous">
        <span aria-hidden="true bg-secondary">&laquo;</span>
      </a>
    </li>
    <li class="page-item "><input type="submit" name="1" value="1" class="page-link" /></li>
    <li class="page-item "><input type="submit" name="1" value="2" class="page-link" /></li>
    <li class="page-item "><input type="submit" name="1" value="3" class="page-link" /></li>
    <li class="page-item "><input type="submit" name="1" value="4" class="page-link" /></li>
    <li class="page-item "><input type="submit" name="1" value="5" class="page-link" /></li>

    <li class="page-item">
      <a class="page-link" href="getDiet_Recipe_6Page" aria-label="Next">
