																			...
																			<div class="card-body">
																				<div class="table-responsive">
																					<table class="table table-bordered table-hover"
																						...
																						<tbody>
																							<c:forEach items="${DetailNoticepage }"
																								var="DetailNotice">
																								<tr>
																									<td>${DetailNotice.notice_no }</td>
																									<td><a
																										href="<c:url value="/update_view?notice_no=${DetailNotice.notice_no }"/>">

																											<a
																											href="<c:url value="/Notice/${DetailNotice.notice_no }"/>">${DetailNotice.title}</a></td>

																									</a>
																									<td>${DetailNotice.userName }</td>
																									<td>${DetailNotice.whenPost }</td>
																									<td>${DetailNotice.notice_view }</td>
																									...
																									{	
																									 %>
																										...
																										<input type="hidden" name="notice_no" value="${DetailNotice.notice_no }">
																											<td><input type="submit" value="글 삭제하기"
																					...
																					<div style="text-align: center;">
																						<c:set var="totalPages"
																							value="${Math.ceil(DetailNotice.size() / 5)}" />
